...
export default async function FleetPage({ params }) {
  ...
  const labels = {
    ...
    showMore: tr('showMore'),
    unavailableGroup: tr('unavailableGroup'),
    ...
    card: {
      ...
      totalForDays: tr('card.totalForDays'),
      fromPrice: tr('card.fromPrice'),
      see: tr('card.see'),
      select: tr('card.select'),
      available: tr('card.available'),
      lastOne: tr('card.lastOne'),
      unavailable: tr('card.unavailable'),
      nextAvailable: tr('card.nextAvailable'),
      seats: tr('card.seats'),
